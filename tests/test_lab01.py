...
def test_ex3_disease_symptoms_value(student_namespace):
...
def test_ex4_first_disease_rubella(student_namespace):
...
def test_ex4_second_disease_cholera(student_namespace):
...
def test_ex4_third_disease_gerd(student_namespace):
...
# ============== Exercise 5: Loop Through Data (20 points) ==============

def test_ex5_disease_names_exists(student_namespace):
    """Test that disease_names variable exists"""
    assert 'disease_names' in student_namespace, "Variable 'disease_names' not found"


def test_ex5_disease_names_is_list(student_namespace):
...
def test_ex5_disease_names_correct(student_namespace):
